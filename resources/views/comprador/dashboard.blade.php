...
<x-app-layout>
    <div class="container mx-auto mt-12 p-8 bg-white rounded-lg shadow-lg">
        ...
        <div class="mt-8 p-4 border rounded-lg bg-gray-100">
            ...
            <a href="{{ route('comprador.cart.index') }}" class="mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#f10707] transition duration-200">
                Ver Carrito
            </a>
        </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('comprador.index') }}" class="px-4 py-2 bg-[#f10707] text-white rounded-md hover:bg-blue-600 transition duration-200">
