    ...
    <div class="container mx-auto mt-12 p-8 bg-white rounded-lg shadow-lg">
        ...
        <div class="mt-8">
            ...
            <ul class="mt-2 space-y-3">
                <li>
                    <a href="{{ route('vendedor.products.index') }}" class="block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-[#f10707] transition duration-200 text-center">
                        Ver Productos
                    </a>
                </li>
                <li>
                    <a href="{{ route('vendedor.products.create') }}" class="block px-4 py-2 bg-[#f10707] text-white rounded-md hover:bg-blue-600 transition duration-200 text-center">
                        Agregar Producto
                    </a>
                </li>
            </ul>
